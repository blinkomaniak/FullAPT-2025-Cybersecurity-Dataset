"""
Stage 02: LSTM Encoding with Anti-Data-Snooping Logic

This script performs feature encoding for LSTM-SAE with proper temporal sequence creation
...
# === CLI Args ===
parser = argparse.ArgumentParser(description="Encode dataset into sequences for LSTM-SAE")
parser.add_argument("--dataset", required=True, help="Dataset name")
parser.add_argument("--version", required=True, help="Dataset version")
parser.add_argument("--model", required=True, help="Model (e.g., lstm-sae)")
