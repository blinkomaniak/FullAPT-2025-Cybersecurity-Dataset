"""
Stage 04: Evaluate GRU-SAE model with Anti-Data-Snooping Logic

This script evaluates the trained GRU autoencoder on the test set (never seen during training)
using reconstruction error as the anomaly score for sequence-based anomaly detection.

Steps:
1. Load test sequences and trained GRU-SAE model
...
# === CLI Args ===
parser = argparse.ArgumentParser(description="Evaluate GRU-SAE model")
